package scripts.dax.walker_engine.navigation_utils.fairyring;
...
import scripts.dax.walker_engine.interaction_handling.InteractionHelper;
import scripts.dax.walker_engine.navigation_utils.fairyring.letters.FirstLetter;
import scripts.dax.walker_engine.navigation_utils.fairyring.letters.SecondLetter;
import scripts.dax.walker_engine.navigation_utils.fairyring.letters.ThirdLetter;

import static scripts.dax.walker_engine.navigation_utils.fairyring.letters.FirstLetter.*;
import static scripts.dax.walker_engine.navigation_utils.fairyring.letters.SecondLetter.*;
import static scripts.dax.walker_engine.navigation_utils.fairyring.letters.ThirdLetter.*;
