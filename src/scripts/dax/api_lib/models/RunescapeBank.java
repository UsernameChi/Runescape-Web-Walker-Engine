...
public enum RunescapeBank {
    ...
    FOSSIL_ISLAND_WRECK(3771, 3898, 0),
    ...
    HALLOWED_SEPULCHRE(2400, 5983, 0),
    HOSIDIUS(1749, 3599, 0),
    HOSIDIUS_KITCHEN(1676, 3617, 0),
    HUNTERS_GUILD(1542, 3041, 0),
    JATIZSO(2416, 3801, 0),
    ...
    MINING_GUILD(3013, 9718, 0),
    MOR_UL_REK(2541, 5140, 0),
    ...
    TZHAAR(2446, 5178, 0),
    VARLAMORE_EAST(1780, 3094, 0),
    VARLAMORE_WEST(1647, 3118, 0),
    VARROCK_EAST(3253, 3420, 0),
    VARROCK_WEST(3185, 3441, 0),
    VINERY(1808, 3570, 0),
    VINERY_BANK(1809, 3566, 0),
    VOLCANO_BANK(3819, 3809, 0),
